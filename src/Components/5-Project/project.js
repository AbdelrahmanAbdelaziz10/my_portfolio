              ...
              return (
                <Col key={item.id} lg="4" md="6" sm="1" className="mb-3">
                  <motion.article
                    ...
                    class="card "
                  >
                    <motion.img src={item.imagePath} class="card-img-top p-1" alt="..." />
                    <motion.div class="card-body">
                      ...
                      <Col className="d-flex ">
                        <a href={item.demoPath} target="_blank"  className="card_icon">
                          <FaLink />
                        </a>
                        <a href={item.CodePath} target="_blank"  className="card_icon">
                          <FaGithub />
                        </a>
                      </Col>
                    </motion.div>
